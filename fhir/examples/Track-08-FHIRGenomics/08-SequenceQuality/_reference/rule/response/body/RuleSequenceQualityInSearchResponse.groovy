/*
 ...
 rule.description=Verify that the Bundle contains Sequence resources that all defined a quality score value
*/
...
if (contentType=='JSON') {
	...
	assert sequenceEntries.size() == sequenceQualityEntries.size(): "Not all Sequence resources found in searchset Bundle entries have defined quality score values"
} else {
